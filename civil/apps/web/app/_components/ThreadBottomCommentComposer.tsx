...
export default function ThreadBottomCommentComposer({
  ...
  return createPortal(
    <div
      className="fixed inset-x-0 z-[90] border-t border-slate-200 bg-white/95 px-3 pb-[max(0.45rem,env(safe-area-inset-bottom))] pt-2 shadow-[0_-8px_20px_rgba(15,23,42,0.08)] lg:hidden"
