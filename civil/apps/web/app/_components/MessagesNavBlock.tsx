          ...
          return (
            ...
            >
              ...
              {unreadCount > 0 ? (
                <span
                  className={clsx(
                    'absolute -right-1 -top-1 inline-flex min-w-5 items-center justify-center rounded-full px-1.5 py-0.5 text-[10px] font-bold leading-none text-white',
                    isActive ? 'bg-[var(--cc-primary)]' : 'bg-red-500',
                  )}
                >
