...
import { JURISDICTION_LABELS, type ApiPost } from './PostComposer'
import RichTextEditor from './RichTextEditor'
import CommentComposer from './CommentComposer'
import CommentThread, { type ApiComment } from './CommentThread'
import CivilLinkPreviewList from './CivilLinkPreviewList'
import CivilPostMedia from './CivilPostMedia'
import CauseContributorCard, { type CauseContributorItem } from './CauseContributorCard'
import CauseSummaryCard from './CauseSummaryCard'
import LinkPreviewCard from './LinkPreviewCard'
import LinkifiedText from './LinkifiedText'
import PostReactionBar from './PostReactionBar'
import PollCard from './PollCard'
import ThreadBottomCommentComposer from './ThreadBottomCommentComposer'
...
import { useRegisterPageView } from './AnalyticsTracker'
        ...
        <article className="cc-thread-surface flex min-h-[calc(var(--cc-viewport-height)-7.5rem)] flex-col rounded border bg-white p-6 shadow-sm lg:min-h-0">
          ...
          <header className="relative space-y-4 border-b border-gray-100 pb-4">
            ...
            <div className="space-y-4 text-[16px] leading-7 text-gray-900">
              {post.type !== 'cause' && (post.video || post.mediaUrl) ? <CivilPostMedia images={post.images} mediaUrl={post.mediaUrl} postId={post.id} video={post.video} /> : null}
              ...
              {post.type === 'cause' ? <CivilPostMedia images={post.images} mediaUrl={post.mediaUrl} postId={post.id} video={post.video} /> : null}
