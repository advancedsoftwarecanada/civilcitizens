  ...
  const loadEditor = useCallback(async () => {
    ...
    try {
      ...
      if (!response.ok || !payload?.item) {
        ...
        router.replace('/settings/guardian')
        return
      }
      ...
      <div className="space-y-6">
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">Guardian Mode</p>
            ...
            <Link href="/settings/guardian" className="inline-flex rounded-full border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 transition hover:border-slate-300 hover:text-slate-900">
            ...
            <aside className="space-y-4">
                    ...
                    <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3">
                      <div className="flex items-start gap-2 text-amber-900">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm text-amber-900/80">{item.suspensionNote ?? 'Your account has been suspended by Guardian Mode, please ask your parent or guardian to restore your account.'}</p>
              ...
              <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                {modePreview ? (
                  ...
                  <p className="mt-4 text-sm text-slate-500">Add a valid date of birth to preview the child&apos;s Guardian Mode band.</p>
                )}
              </section>
            </aside>
          </div>
