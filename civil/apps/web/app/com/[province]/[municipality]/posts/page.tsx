...
export default function CommunityPostsPage() {
  return (
    <div className="space-y-6 py-8">
      ...
      >
        <p>
          Posts automatically scope to the selected municipality, respecting its default chamber while still supporting
          Canada-wide civic broadcasts. Use the filters below to switch between citizen, municipal, provincial, and
          federal dispatches.
        </p>
      </CommunitySection>
