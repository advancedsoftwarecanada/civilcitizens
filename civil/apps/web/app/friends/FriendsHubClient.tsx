...
function ParentFamilyRightRail({
  ...
  return <FamilyRailBlock entries={entries} loading={loading} onSelectMember={onSelectMember} viewAllHref={viewAllHref} />
}
  ...
  const rightRail = (
    <div className="space-y-4">
      <ParentFamilyRightRail
        ...
        viewAllHref={viewer?.handle ? `/u/${viewer.handle}/family` : '/family'}
      />
